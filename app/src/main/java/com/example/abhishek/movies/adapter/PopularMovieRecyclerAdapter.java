...
public class PopularMovieRecyclerAdapter extends RecyclerView.Adapter<PopularMovieRecyclerAdapter.ItemViewHolder> {
    private Context context;
    private LayoutInflater layoutInflater;
    private ArrayList<JSONObject> list;
    private String TAG = "PopularMovieRecyclerAdapter";

    public PopularMovieRecyclerAdapter(Context context, ArrayList<JSONObject> data) {

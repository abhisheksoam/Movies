...
/**
 * Created by abhishek on 21/09/17.
 */
 ...
 */
@TargetApi(13)
public final class VideoPlay extends Activity implements OnFullscreenListener {
    ...
    private static ArrayList<Trailer> trailerList = new ArrayList<>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent!=null){
            trailerList = (ArrayList<Trailer>) intent.getSerializableExtra("video_detail");
        }
    ...
    public static final class VideoListFragment extends ListFragment {
...

        {
            ...
            for(int i=0;i<trailerList.size();i++){
                list.add(new VideoEntry(trailerList.get(i).getName(),trailerList.get(i).getKey()));
            }
            VIDEO_LIST = Collections.unmodifiableList(list);
//            list.add(new VideoEntry(trailerList.get(0).))
...
//            list.add(new VideoEntry("Translate for Animals", "3I24bSteJpw"));
    ...
    public static final class VideoFragment extends YouTubePlayerFragment
        ...
        public void onInitializationSuccess(Provider provider, YouTubePlayer player, boolean restored) {
            ...
            player.setOnFullscreenListener((VideoPlay) getActivity());
